 ...
 * 
 * This class is designed to perform tests
 * based on the components of the program.
 * 
 * PURPOSE OF THE PROGRAM:
 * The purpose of this program is to track the books in the library
 * within the data including authors, customers, books, and some general information
 * about the library. Main purpose is to keep the books safe and get them back correctly.
 * Some operations of any library are implemented.
 * 
 */
